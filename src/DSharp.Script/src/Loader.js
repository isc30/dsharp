...
(function (global) {
  function _ss() {
    ...
    return extend(module('ss', null, {
        ...
        IEnumerable_$1: defineInterface(IEnumerable_$1),
        IEnumerator: defineInterface(IEnumerator),
        IEnumerator_$1: defineInterface(IEnumerator_$1),
        ...
        IList: defineInterface(IList),
        IList_$1: defineInterface(IList_$1),
        IReadOnlyList_$1: defineInterface(IReadOnlyList_$1),
